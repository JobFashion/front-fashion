...
export function Register() {
  ...
  const styles = {
    field: 'w-full h-[4.3rem] mb-1 flex flex-col',
    ...
    form: 'w-[95%] flex flex-col items-center justify-center'
  }
  ...
  return (
    ...
    >
      {({ isSubmitting, errors, values }) => {
        ...
        const passwordChecker = !errors.verifyPassword && values.verifyPassword && values.password
          ? icons.ok
        ...
        return (
          <Form className={styles.form}>
            ...
            <button style={{ opacity: check ? 1 : 0.4 }} className={styles.button} type="submit" disabled={isSubmitting}>
              Registrarme
            </button>
          </Form>
        )
